...
class Markov:
    ...
    def generate(self, keyword):
        ...
        # keywordがprefix1として登録されていない場合，_startsからランダムに生成する
        ...
        # その後prefix1, prefix2をスライドさせ始めに戻る
